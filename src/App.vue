...
<template>
  ...
  <div id="cards">
    <!-- This is our word card component and we treat the wordcard component as an html element-->
    <!-- the v-bind:word is used to get the individual word from the wordcard passing the props data-->
    <WordCard
